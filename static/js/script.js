                ...
                row.innerHTML = `
                    ...
                    <td>
                        <div class="action-btns">
                            ...
                            <button class="btn btn-sm btn-outline-danger delete-btn" data-fileid="${escapeAttr(file.file_id)}" data-displayname="${escapeAttr(file.name)}" title="Delete file" aria-label="Delete file ${escapeAttr(file.name)}">🗑️</button>
                        </div>
                    </td>
                `;
