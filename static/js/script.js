                ...
                row.innerHTML = `
                    <td>
                        <div class="file-cell">
                            ...
                            <button class="btn btn-sm btn-link copy-btn p-0" title="Copy filename" aria-label="Copy filename: ${escapeHtml(file.name)}">📋</button>
                        </div>
                    </td>
                    ...
                    <td>
                        <div class="action-btns">
                            ${getShareToken(file.file_id) ? `<button class="btn btn-sm btn-outline-info share-btn" data-token="${escapeHtml(getShareToken(file.file_id))}" title="Copy share link" aria-label="Copy share link for ${escapeHtml(file.name)}">🔗</button>` : '<span class="action-placeholder"></span>'}
                            <button class="btn btn-sm btn-outline-primary email-pkg-btn" data-fileid="${escapeHtml(file.file_id)}" data-displayname="${escapeHtml(file.name)}" title="Download for Email" aria-label="Download email package for ${escapeHtml(file.name)}">📧</button>
                            <button class="btn btn-sm btn-outline-danger delete-btn" data-fileid="${escapeHtml(file.file_id)}" data-displayname="${escapeHtml(file.name)}" title="Delete file" aria-label="Delete file ${escapeHtml(file.name)}">🗑️</button>
                        </div>
                    </td>
                `;
